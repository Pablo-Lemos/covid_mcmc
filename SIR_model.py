...
def integrate_SIR(S0, I0, Q0, R0, D0, ndays, beta, gamma, q, mu, model='simple'):
    ...
    if model=='simple':
        ...
        ret = odeint(deriv_SIR_global, y0, t, args=(beta, gamma, q, mu))
...
def deriv_SIR(y, t, beta, gamma, q, mu):
    ...
    dSdt = -beta * S * I / N
    dIdt = beta * S * I / N  - gamma * I - q*I - mu*I
    dQdt = q * I - gamma*Q
    dRdt = gamma * I + gamma*Q
    dDdt = mu*I
    return dSdt, dIdt, dQdt, dRdt, dDdt

def deriv_SIR_global(y, t, beta, gamma, q, mu):
    ''' The SIR model differential equations
...
def logp_SIR(lbeta, lgamma, q, lmu):
    ...
    _, I_theory, _, _, D_theory = integrate_SIR(S0, I0, Q0, R0, D0, ndays, beta, gamma, q, mu, model='simple')
...
def logp_SIR_global(lbeta, lgamma, q, lmu):
    ''' 
    Calculate the log likelihood for the SIR model given parameters
    ...
    _, I_theory, _, _, D_theory = integrate_SIR(S0, I0, Q0, R0, D0, ndays, beta, gamma, q, mu, model='global')
